          ...
          >
            <Container
              ...
              iconType={
                ...
                ['other_voicemails', 'call_messages', 'spam_calls', 'missed_by_customer_v', 'missed_by_cc_v', 'missed_voicemails', 'other_missed', 'callback_req_v', 'unanswered_transferred_v', 'abandoned_rang_v', 'cancelled', 'successful_callbacks', 'unsuccessful_callbacks', 'callback_attempts'].includes(selectedNodeForDetails.nodeId) ? 'phone-only' :
                'both'
              }
            />
          </div>
